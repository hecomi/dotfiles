...
" My Syntax
syn region starredLine start="★" end="$"
syn region titleLine start="\(■\|◆\)" end="$"

syn region  separator1 start="===" end="$"
syn region  separator2 start="---" end="$"
syn cluster separator add=separator1,separator2
...
" For version 5.8 and later: only when an item doesn't have highlighting yet
  ...
  HiLink starredLine            Keyword
  HiLink separator              Comment
  HiLink titleLine              Special
